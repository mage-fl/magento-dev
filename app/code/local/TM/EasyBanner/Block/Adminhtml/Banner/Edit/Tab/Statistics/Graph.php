<?php
class TM_EasyBanner_Block_Adminhtml_Banner_Edit_Tab_Statistics_Graph
    extends Mage_Adminhtml_Block_Dashboard_Graph
{
    public function __construct()
    {
        ...
        parent::__construct();
        $this->setTemplate('tm/easybanner/banner/graph.phtml');
    }
    ...
    public function getChartUrl($directUrl = true)
    {
        ...
        if (!in_array($period, array_keys($this->getDataHelper()->getDatePeriods()))) {
            $this->getDataHelper()->setParam('period', '7d');
        }
        ...
        list ($dateStart, $dateEnd) = Mage::getResourceModel('easybanner/banner_statistic_collection')
