...
class TM_ProLabels_Block_Adminhtml_Rules_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    public function getSelectedRelatedProducts()
    {
        ...
        $label = Mage::registry('prolabels_rules');
        $products = $model->getLabelProductIds($label->getId());
