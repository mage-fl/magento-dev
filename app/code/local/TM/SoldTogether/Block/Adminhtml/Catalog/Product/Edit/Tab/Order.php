...
class TM_SoldTogether_Block_Adminhtml_Catalog_Product_Edit_Tab_Order extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
        parent::__construct();
        $this->setId('soldtogether_order_product_grid');
